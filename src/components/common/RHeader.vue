              ...
              <div class="gnb-toggle-wrap">
                ...
                <div class="gnb-main-list" data-has-submenu="true">
                  <ul>
                    ...
                    <li>
                      <a href="#" class="gnb-sub-trigger is-link external-link" data-trigger="gnb" target="_blank"
                        title="새 창 열림">2Depth</a>
                    </li>
                  </ul>
                </div>
                <!-- //gnb-main-list -->
                      ...
                      <div class="gnb-sub-list">
                        <div class="gnb-sub-content">
                          ...
                          <ul class="type-description">
                            <li>
                              <h3 class="tit">
                                <a href="#" target="_blank" title="새 창 열림">3Depth title <i
...
import { krds_mainMenuPC } from '@/utils/krds-ui-script/krds_mainMenuPC'
import { krds_mainMenuMobile } from '@/utils/krds-ui-script/krds_mainMenuMobile'
import { krds_dropEvent } from '@/utils/krds-ui-script/krds_dropEvent'
